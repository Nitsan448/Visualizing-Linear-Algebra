...
public static class CommonMatrixTransfomations
{
	...
	public static Matrix4x4 RotationAroundZAxis = new Matrix4x4(new Vector4(0, -1, 0, 0),
		new Vector4(1, 0, 0, 0), new Vector4(0, 0, 1, 0), new Vector4(0, 0, 0, 1));
